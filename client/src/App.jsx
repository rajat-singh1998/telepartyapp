...
const createRainParticles = (icon, count = 420, className = "") =>
  Array.from({ length: count }, (_, index) => ({
    ...
    driftMid: `${-32 + Math.random() * 64}px`,
    driftLate: `${-56 + Math.random() * 112}px`,
    drift: `${-84 + Math.random() * 168}px`,
          ...
          burst.particles.map((particle) => (
            <span
              ...
              style={{
                ...
                "--rain-drift-mid": particle.driftMid,
                "--rain-drift-late": particle.driftLate,
